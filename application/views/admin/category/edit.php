<div class="list_details_wrap">
    <h3>Edit Category</h3>
    <div class="form_wrap">
        <form method="post" action="<?php echo base_url() ?>admin/category/update" onsubmit="return validate(['name'])">
            <input type="hidden" value="<?php echo $category_id; ?>" name="category_id" />
            <table border="0">
                <tr>
                    <td>Name:</td>
                    <td><input type="text" value="<?php echo $category['name']; ?>" class="form-control" name="name" id='name'/></td>
                </tr>
                <tr>
                    <td colspan="2">
